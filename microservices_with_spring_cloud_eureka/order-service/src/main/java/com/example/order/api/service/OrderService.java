...
public class OrderService {
    ...
    /*
     * This is important to notice that we are using 'PAYMENT-SERVICE' instead of
     * host:port of payment service instance. On runtime, this name gets referenced
     * from eureka service registry and call gets redirected to corresponding
     * host:port.
     */
    private static final String PAYMENT_GATEWAY_API_PATH = "http://PAYMENT-SERVICE/payment/v1";
